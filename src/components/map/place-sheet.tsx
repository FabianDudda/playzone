...
export default function PlaceSheet({
  ...
  return (
    ...
    <EventSheet
      isOpen={isOpen && !!selectedCourt?.is_event_only}
      onOpenChange={onOpenChange}
      eventId={selectedCourt?.is_event_only ? selectedCourt.id : null}
      userLocation={userLocation}
      user={user}
    />

    <Drawer open={isOpen && !selectedCourt?.is_event_only} onOpenChange={onOpenChange} modal={false} shouldScaleBackground={false}>
